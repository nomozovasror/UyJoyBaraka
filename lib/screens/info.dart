            ...
            children: [
                ...
                CarouselSlider.builder(
                  ...
                  itemBuilder:
                    ...
                    final imgL = ApiEndPoints.BASE_URL +
                        widget.allData.thumb![index].toString();
                    return SizedBox(
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      timeSlicer(widget.allData.createdAt!),
                    ...
                    Row(
                      children: [
                        ...
                        Text(
                          widget.allData.viewCount.toString(),
                          style: const TextStyle(
                            fontSize: 14,
                            fontWeight: FontWeight.w400,
                            color: Color(0xff666666),
              ...
              Row(
                children: [
                  Padding(
                    ...
                    child: Text(
                        "${widget.allData.price.toString()} ${widget.allData.priceType == 'dollar' ? '\$' : 'so\'m'}",
                        style: const TextStyle(
                            fontSize: 20,
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Row(
                    children: [
                      CircleAvatar(
                        backgroundImage: NetworkImage(ApiEndPoints.BASE_URL +
                            widget.allData.avatar.toString()),
                        radius: 30,
                      ),
                      const SizedBox(
                        width: 10,
                              ...
                              Navigator.of(context).push(
                                MaterialPageRoute(
                                  builder: (context) => InfoScreen(
                                    allData:
                                        getAllItemController.allItem[index],
                                  ),
                                ),
                              );
                            },
