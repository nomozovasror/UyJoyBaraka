                                    ...
                                    Navigator.of(context).push(
                                      MaterialPageRoute(
                                        builder: (context) => UpdatePostScreen(
                                             post: getActivePostController.allActiveItem[index],),
                                      ),
                                    );
                                  },
                                  child: Container(
                                            ...
                                            children: [
                                              ...
                                              Expanded(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      const Icon(
                                                        Icons.remove_red_eye_outlined, color: Colors.grey, size: 16,),
                                ...
                                return GestureDetector(
                                  onTap: () {
                                    Navigator.of(context).push(
                                      MaterialPageRoute(
                                        builder: (context) => UpdatePostScreen(
                                          post: getInactivePostController.allActiveItem[index],),
                                      ),
                                    );
                                  },
                                  child: Container(
