      ...
      child: Column(
        ...
        children: [
          Flexible(
            child: Obx(
              () {
                return likeController.likedPosts.isNotEmpty ? StaggeredGridView.countBuilder(
                  crossAxisCount: 2,
                        ...
                        Navigator.of(context).push(
                          MaterialPageRoute(
                            builder: (context) => LikedInfoScreen(
                                allData: likeController.allLikedPost[index]),
                          ),
                        );
                      },
                      child: Container(
                            ...
                            Container(
                              ...
                              child: CachedNetworkImage(
                                imageUrl: ApiEndPoints.BASE_URL +
                                    likeController
                                        .allLikedPost[index].announcementThumb![0],
                ...
                [
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Lottie.asset('assets/lottie/favorite.json', height: 200,),
                    ],
                  ),
                  const SizedBox(height: 20,),
                  const Text('Sizda saqlangan e\'lonlar yo\'q', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),),
                  const SizedBox(height: 20,),
                  const Text('Siz saqlangan e\'lonlarni shu yerda ko\'rishingiz mumkin', style: TextStyle(fontSize: 14, color: Colors.grey),),
                ],);
              }
              ),
          ),
